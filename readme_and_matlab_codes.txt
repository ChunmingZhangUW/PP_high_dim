...
Readme description for producing Figure 2 (left panel and right panel) and Figure 1 (left panel) of the submitted paper by Zhang, Ye and Wang (2022). Inputs, e.g., sample size $n$, data dimension $p$ and types of data distribution, used in codes for other figures can be similarly and manually adjusted.
